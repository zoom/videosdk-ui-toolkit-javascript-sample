...
export type OldUIkitFeature = "preview" | "video" | "audio" | "share" | "chat" | "users" | "settings";
 ...
 * @property userName - Display name of the participant
...
export interface UIToolkit {
  ...
  /**
   * Shows the meeting controls component.
   *
  ...
  /**
   * Hides the meeting controls component.
   *
   ...
   *
   * @param container - DOM element containing users list
   * @category Customize Layout
   */
